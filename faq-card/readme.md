...
HTML: 
  - Initially I started out with the layout of containers for the image and question card seperate
  - When I got to the responsive desktop design - this proved difficult to position the image alongside the 
